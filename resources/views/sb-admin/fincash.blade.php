...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-1">
            ...
            <a href="{{ route('fincash.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-dark shadow-sm" wire:navigate>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mt-3 mb-1">
            ...
            <strong>
                <p class="me-4 mb-4">Valor Inicial do Caixa: <span id="caixa-value" role="button">R${{ $unfinishedFincash->fincash_value }}</span></p>
                <script>
